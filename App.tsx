...
const App: React.FC = () => {
  ...
  const [legalModalState, setLegalModalState] = useState<{ open: boolean, type: 'privacy' | 'terms' }>({ open: false, type: 'privacy' });
  ...
  const openLegal = (type: 'privacy' | 'terms') => setLegalModalState({ open: true, type });
  const closeLegal = () => setLegalModalState({ ...legalModalState, open: false });
          ...
          <div className="mb-14 pt-2">
            <div className="flex flex-col items-center text-center cursor-pointer group" onClick={navigateToHome}>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[9px] font-black text-slate-600 uppercase tracking-[0.2em]">AI MARKETING DIRECTOR</span>
              </div>
            </div>
          </div>
